    ...
    <div class="flex flex-col items-center gap-8 xl:gap-16 lg:flex-row">
      <div class="text-center md:max-w-3xl lg:text-left xl:shrink-0">
        ...
        <div class="flex items-center justify-center gap-4 mt-8 lg:justify-start">
          <a href="#" title=""
            class="px-5 py-3 text-base font-medium text-center text-white bg-primary-500 rounded-lg shrink-0 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-800 dark:focus:ring-primary-800"
            role="button">
            Buy now for $99
          </a>

          <a href="#" title=""
            class="inline-flex items-center px-5 py-3 text-base font-medium text-center text-gray-900 bg-white border border-gray-200 rounded-lg shrink-0 focus:outline-none hover:bg-gray-100 hover:text-prima focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
            role="button">
            Free preview
      ...
      <div class="max-w-md">
        <img class="object-contain w-auto rounded-[1rem] shadow-2xl" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/hero/book.png" alt="Book cover">
      </div>
    </div>
  </div>
</section>