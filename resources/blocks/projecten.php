      ...
      <div class="projecten-carousel relative mx-4 lg:mx-12">
        <?php if (have_rows('projecten')): ?>
          ...
          <div class="h-full px-2">
            <article class="flex flex-col min-h-[600px] p-4 bg-white rounded-lg border border-gray-200">
               <?php if (get_sub_field('uitgelichte_afbeelding')): ?> 
                <figure class="w-full h-48 md:h-56 lg:h-64 mb-5">
                ...
                <div class="flex flex-col flex-grow">
                    ...
                    <h2 class="my-2 text-xl md:text-2xl font-bold tracking-tight text-gray-900">
                        <?php echo get_sub_field('project_titel'); ?>
                    </h2>
                    <div class="text-base md:text-lg font-light text-gray-500 overflow-y-auto"><?php echo get_sub_field('beschrijving'); ?></div>
                </div>
            </article>
          </div>
          <?php endwhile; ?>
