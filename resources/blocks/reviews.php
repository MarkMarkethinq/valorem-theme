        ...
        <div id="testimonial-carousel" class="relative" data-carousel="slide">
            <div class="overflow-x-hidden overflow-y-visible relative mx-auto max-w-screen-md h-52 rounded-lg sm:h-48">
                ...
                <figure class="hidden mx-auto w-full max-w-screen-md" data-carousel-item>
                    <blockquote>
                        <div class="text-lg font-medium text-gray-900 sm:text-2xl"><?php echo get_sub_field('review_tekst'); ?></div>
                    </blockquote>
                    <figcaption class="flex justify-center items-center mt-6 space-x-3">
                        ...
                        <?php endif; ?>
                        <div class="pr-3 font-medium text-gray-900"><?php echo get_sub_field('bedrijfsnaam'); ?></div>
                    </figcaption>
                </figure>
                <?php endwhile; ?>
                <?php endif; ?>
