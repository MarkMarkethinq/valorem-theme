<section id="diensten" class="bg-white dark:bg-gray-900">
              ...
              <?php if(have_rows('diensten')): ?>
                <?php while(have_rows('diensten')): the_row(); ?>
                  <div class="flex pt-8">
                      ...
                      <div>
                          <h3 class="mb-2 text-xl font-bold text-gray-900 dark:text-white"><?php echo get_sub_field('titel'); ?></h3>
                          <p class="mb-2 font-light text-gray-500 dark:text-gray-400"><?php echo get_sub_field('tekst'); ?></p>
                      </div>
                  </div>
                <?php endwhile; ?>
              <?php endif; ?>
