<section id="over-mij" class="bg-primary-900">
    <div class="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-12 lg:py-16 lg:px-6">
        <div class="font-light text-white text-2xl lg:col-span-7">
            ...
            <?php endif; ?>
            <?php if (get_field('icon') && get_field('icon_link')): ?>
                <a href="<?php echo get_field('icon_link')['url']; ?>" target="<?php echo get_field('icon_link')['target']; ?>">
                    <img class="inline-block h-12 w-12 ml-4 align-middle" src="<?php echo get_field('icon')['url']; ?>" alt="<?php echo get_field('icon')['alt']; ?>">
                </a>
            <?php endif; ?>
        </div>
