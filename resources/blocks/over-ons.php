<section id="over-mij" class="bg-primary-900 dark:bg-gray-900">
    <div class="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-12 lg:py-16 lg:px-6">
        <div class="font-light text-white text-2xl dark:text-gray-400 lg:col-span-7">
            <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-white dark:text-white"><?php echo get_field('titel') ?></h2>
            <p class="mb-4"><?php echo get_field('tekst') ?></p>
            <?php if (get_field('knop')): ?>
            <a href="<?php echo get_field('knop')['url']; ?>" target="<?php echo get_field('knop')['target']; ?>" class="inline-flex text-base items-center py-3 mt-4 px-5 font-medium text-center border border-gray-300 text-black rounded-lg bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-primary-900 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
        ...
        <div class="grid grid-cols-2 gap-4 mt-8 lg:col-span-5">
