<section id="over-mij" class="bg-primary-900">
    <div class="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-12 lg:py-16 lg:px-6">
        <div class="font-light text-white text-2xl lg:col-span-7">
            ...
            <a href="<?php echo get_field('knop')['url']; ?>" target="<?php echo get_field('knop')['target']; ?>" class="inline-flex text-base items-center py-3 mt-4 px-5 font-medium text-center border border-gray-300 text-black rounded-lg bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-primary-900">
