...
<html class="no-js"dir="ltr" <?php language_attributes(); ?>>
  ...
  <body <?php body_class('pt-[60px] lg:pt-[28px]'); ?>>
    ...
    <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 shadow-md">
        <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            ...
            <div class="flex items-center lg:order-3">
                <a href="#contact" class="text-white bg-primary-900 hover:bg-primary-950 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 focus:outline-none">Stuur een bericht</a>
            ...
            <div class="hidden lg:flex lg:w-2/4 justify-end items-center pt-2 lg:order-2" id="mobile-menu-2">
                <?php wp_nav_menu ([
                        'menu' => 'main',
                        'container' => 'ul',
